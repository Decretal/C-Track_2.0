...
void sleepForFiveMinutes() {
  ...
  esp_sleep_enable_timer_wakeup(1000000); //300000000us
...
void loop() {
 //String read_sentence = Serial1.readStringUntil(13); //13 = return (ASCII)
  String read_sentence = Serial1.readStringUntil('\0');
  ...
  if (Serial1.available()) {
    ...
    Serial.print("Read: " + read_sentence + "\n");
    ...
    //String gpsDataString = "{\"id\":1,\"date\":\" 10 \",\"time\":\" 12:30 \",\"latitude\":\"  187 \",\"longitude\":\" 420  \"}";
